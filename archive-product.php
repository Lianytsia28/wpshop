...
<div class="container">
    <div class="buttonFilter" id="buttonFilter">
        <input type="button" value="Filter" onmousedown="viewDiv()">
    </div>
    <div class="blockFilter" id="div11"><?php dynamic_sidebar( 'sidebar-post-single' ); ?></div>
</div>
